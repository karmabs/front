...
import PreviewBonuses from "../../../../components/bonuses/NoWageringBonuses";
...
export default async function Page({ params: { lng } }: PageProps) {
  ...
  return (
    <>
      ...
      <FilteredBonuses data={data} url={url} currentTabActive={currentTab} />
    </>
  );
}
